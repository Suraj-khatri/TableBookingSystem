...
{
    public abstract class RestroWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static RestroWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(RestroWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<RestroDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<RestroDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<RestroDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<RestroDbContext, Task<T>> func)
        {
            T result;
